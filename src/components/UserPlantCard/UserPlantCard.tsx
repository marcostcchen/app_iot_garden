    ...
    <View style={styles.card}>
      ...
      <View style={{ flexDirection: 'row' }}>
        <View style={{ height: '60%', width: '100%', }}>
          ...
          <Text style={[styles.text, { color: 'blue' }]}>Ar: {(parseFloat(ar)).toString()}%</Text>
          <Text style={[styles.text, { color: 'brown' }]}>Solo: {(parseFloat(solo)).toString()}%</Text>
          <Text style={[styles.text, { color: '#8B8000' }]}>Lum: {(parseFloat(luminosidade)).toString()}%</Text>
        </View>
        <Pressable
