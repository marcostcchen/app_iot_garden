  ...
  render() {
    return (
      <>
        ...
        <View style={{ height: 0.7*Dimensions.get('window').height, width: Dimensions.get('window').width, position: 'absolute', top: this.props.isLoading ? 0 : -100000, zIndex: 101, opacity: this.props.isLoading ? 1 : 0, alignItems: 'center', justifyContent: 'center' }}>
